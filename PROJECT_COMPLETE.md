...
### Supabase
- **Host**: `db.quksackpkofbyjzbvjzv.supabase.co`
- **Port**: `5432`
- **Database**: `postgres`
- **User**: `postgres`
- **SSL**: ✅ Включен
...
### Dashboard
https://supabase.com/dashboard/project/quksackpkofbyjzbvjzv
...
| **CLOUD_DATABASE_SETUP.md** | Настройка облачной БД |
| **SUPABASE_STEP_BY_STEP.md** | Пошаговая инструкция |
...
1. Откройте: https://supabase.com/dashboard/project/quksackpkofbyjzbvjzv
2. Слева выберите **"Table Editor"**
3. После регистрации пользователя вы увидите таблицы:
   - `users` - там будет ваш пользователь
   - `services` - пока пусто
   - `orders` - пока пусто
...
# Переменные окружения возьмутся из Supabase
```
